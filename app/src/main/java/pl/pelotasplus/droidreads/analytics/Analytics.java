package pl.pelotasplus.droidreads.analytics;

/* Taken from:
 * https://github.com/JakeWharton/Telecine/blob/master/telecine/src/main/java/com/jakewharton/telecine/Analytics.java
 */
